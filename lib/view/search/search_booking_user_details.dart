...
class SearchUserDetails extends StatefulWidget {
  final MovieSearch movieSearch;

  const SearchUserDetails({super.key, required this.movieSearch});
  @override
  _SearchUserDetailsState createState() => _SearchUserDetailsState();
}

class _SearchUserDetailsState extends State<SearchUserDetails> {
  ...
  void _processBooking() {
    ...
    if (hasDuplicate) {
      ...
      Booking newBooking = Booking(
        ...
        movieTitle: widget.movieSearch.title!,
                ...
                children: [
                  ...
                  widget.movieSearch.title == null
                      ? TextFormField(
                          ...
                          validator: (value) {
                            if (value!.isEmpty) {
                              return "${widget.movieSearch.title}";
                            }
                            return null;
                          },
                        )
